    ...
    <div class="section-tab">
        <el-row v-if="listMode">
            <el-row>
                ...
                <el-col :span="8">
                    <el-select v-model="paramAdvType" filterable placeholder="请选择广告位类型" style="width: 100%;">
                      <el-option
                ...
                <el-col :span="8">
                  ...
                  <el-button type="primary" icon="el-icon-circle-plus-outline" @click="addNewAdvInfo" style="margin-left:5px;">新增广告位</el-button>
                </el-col>
            </el-row>
